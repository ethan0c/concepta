...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Main Content */}
      <main 
        className={`transition-all duration-300 ${isMobileMenuOpen ? 'brightness-75' : ''}`}
        onClick={() => isMobileMenuOpen && setIsMobileMenuOpen(false)}
      >
        {/* Hero Section */}
      <section className="pt-32 pb-20 relative overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed" style={{
        ...
        <div className="absolute inset-0 overflow-hidden opacity-10">
          ...
          <div className="absolute bottom-1/4 left-1/3 w-1.5 h-1.5 bg-white rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
          <div className="absolute top-2/3 right-1/4 w-1 h-1 bg-white rounded-full animate-ping" style={{animationDelay: '3s'}}></div>
          <div className="absolute bottom-1/3 right-2/3 w-2 h-2 bg-white rounded-full animate-pulse" style={{animationDelay: '4s'}}></div>
        </div>
      ...
      <section className="py-20 relative overflow-hidden" style={{
        ...
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="stats-pattern" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
                ...
                <line x1="60" y1="0" x2="60" y2="120" stroke="#0B4BBB" strokeWidth="0.3" opacity="0.2"/>
                <line x1="0" y1="60" x2="120" y2="60" stroke="#0B4BBB" strokeWidth="0.3" opacity="0.2"/>
              </pattern>
            </defs>
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl text-gray-900 mb-4">Trusted by Industry Leaders</h2>
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            >
              <div className="text-4xl font-normal text-blue-600 mb-2">50+</div>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <div className="text-4xl font-normal text-blue-600 mb-2">99.9%</div>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <div className="text-4xl font-normal text-blue-600 mb-2">24/7</div>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <div className="text-4xl font-normal text-blue-600 mb-2">15+</div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="flex items-center p-3 bg-white rounded-lg border border-gray-200">
                  ...
                  <span className="text-sm font-medium text-gray-700">Microsoft Azure AI Partner</span>
                </div>
                <div className="flex items-center p-3 bg-white rounded-lg border border-gray-200">
                  <div className="w-2 h-2 bg-green-500 rounded-full mr-3 flex-shrink-0"></div>
                ...
                <div className="flex items-center p-3 bg-white rounded-lg border border-gray-200">
                  <div className="w-2 h-2 bg-green-500 rounded-full mr-3 flex-shrink-0"></div>
                  <span className="text-sm font-medium text-gray-700">SOC 2 Type II Compliant</span>
                </div>
              </div>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-1 relative overflow-hidden" style={{
                  ...
                  <div className="ml-4">
                    <h3 className="font-medium text-gray-900 mb-1">Government-Grade Security</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="font-medium text-gray-900 mb-1">Microsoft Certified Experts</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="font-medium text-gray-900 mb-1">Rapid Deployment</h3>
            ...
            <div className="relative">
              <div className="rounded-lg p-8 text-white relative overflow-hidden" style={{
                ...
                <div className="absolute inset-0 opacity-5">
                  <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                      <pattern id="card-mesh" x="0" y="0" width="50" height="50" patternUnits="userSpaceOnUse">
                        <circle cx="25" cy="25" r="0.5" fill="white" opacity="0.4"/>
                        <line x1="25" y1="0" x2="25" y2="50" stroke="white" strokeWidth="0.1" opacity="0.2"/>
                        <line x1="0" y1="25" x2="50" y2="25" stroke="white" strokeWidth="0.1" opacity="0.2"/>
                      </pattern>
                    </defs>
                ...
                <div className="relative z-10">
                  <h3 className="text-2xl font-medium mb-6">Ready to Get Started?</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-8">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl font-medium text-gray-900 mb-4">Resources & Insights</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Stay ahead with the latest cybersecurity insights, industry best practices, and technology partnerships
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-12">
              ...
              >
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-6">Additional Resources</h3>
                <div className="space-y-4">
                  {[
                    ...
                    <a key={index} href="#" className="flex items-center text-blue-600 hover:text-blue-700 font-medium group py-2 px-3 rounded hover:bg-blue-50 transition-all">
                      <svg className="w-4 h-4 mr-3 group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" />
                      </svg>
                      {resource}
                    </a>
            ...
            >
              <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100 h-full">
                <h2 className="text-2xl font-medium text-gray-900 mb-6">Our Technology Partners</h2>
                <p className="text-gray-600 mb-8 leading-relaxed">
                  Concepta partners with leading technology companies and cloud service providers to deliver continuous innovation and compliant services to our customers. This provides access to specialized training and collaboration with them on their technologies.
                </p>
                ...
                <div className="grid grid-cols-3 gap-6 items-center text-center mb-8">
                  {[
                    ...
                    <div key={index} className="h-16 flex items-center justify-center p-2 rounded-lg hover:bg-gray-50 transition-colors">
                      <Image
                        src={partner.src}
                        alt={partner.alt}
                        width={80}
                  ...
                  <ul className="space-y-3 text-sm text-gray-600">
                    {[
                      ...
                      <li key={index} className="flex items-center">
                        <div className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mr-3" style={{
                          background: 'radial-gradient(circle at top left, #0B4BBB, #082E84 70%)'
                        }}>
      ...
      <footer className="text-white py-12 relative overflow-hidden" style={{
          ...
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="footer-mesh" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
                ...
                <line x1="40" y1="0" x2="40" y2="80" stroke="white" strokeWidth="0.15" opacity="0.1"/>
                <line x1="0" y1="40" x2="80" y2="40" stroke="white" strokeWidth="0.15" opacity="0.1"/>
              </pattern>
            </defs>
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="grid lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <div className="flex items-center mb-4">
                ...
                <div className="ml-3">
                  ...
                  <div className="text-blue-200 text-xs">Innovation Systems</div>
                </div>
              </div>
            </div>
            ...
            {/* Services */}
            <div>
              <h4 className="text-sm font-medium mb-3 text-blue-200">Services</h4>
            ...
            {/* Contact */}
            <div>
              <h4 className="text-sm font-medium mb-3 text-blue-200">Contact</h4>
            ...
            {/* Newsletter */}
            <div>
              <h4 className="text-sm font-medium mb-3 text-blue-200">Newsletter</h4>
      ...
      <section className="py-8 relative overflow-hidden" style={{
        ...
        <div className="absolute inset-0 opacity-5">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="bottom-pattern" x="0" y="0" width="120" height="120" patternUnits="userSpaceOnUse">
                <circle cx="60" cy="60" r="1.5" fill="#0B4BBB" opacity="0.4"/>
                <circle cx="30" cy="30" r="0.8" fill="#0B4BBB" opacity="0.3"/>
                <circle cx="90" cy="30" r="0.8" fill="#0B4BBB" opacity="0.3"/>
                <circle cx="30" cy="90" r="0.8" fill="#0B4BBB" opacity="0.3"/>
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 mb-4 lg:mb-0">
              <p className="text-gray-700 text-sm">© 2025 Concepta Innovation Systems, LLC. All rights reserved.</p>
              <div className="flex items-center space-x-4 text-sm">
                ...
                <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Accessibility</a>
              </div>
            </div>
            <div className="flex items-center space-x-4">
