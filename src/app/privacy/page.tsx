          ...
          <div className="page-container">
            <div className="max-w-3xl">
              ...
              <div className="prose prose-gray max-w-none space-y-8">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Personal Data</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">How We Use Personal Data</h2>
                  <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Protection of Personal Information</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Interaction with Children</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Special Notices to California Residents</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Where Information is Maintained</h2>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">Changes to this Privacy Statement</h2>
                  <p className="text-gray-700 leading-relaxed">
