        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 mb-10 sm:mb-14">
            ...
            <ul className="space-y-2.5">
              {services.map((service) => (
                <li key={service.label}>
                  <Link href={service.href} className="text-sm text-gray-300 hover:text-white transition-colors">
                    {service.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-2 mb-5">
              <a href={`tel:${phone.replace(/[^0-9+]/g, "")}`} className="block text-sm text-gray-300 hover:text-white transition-colors">
                {phone}
              </a>
              <a href={`mailto:${email}`} className="block text-sm text-gray-300 hover:text-white transition-colors break-all">
                {email}
              </a>
            </div>
