    ...
    <section className="py-20 sm:py-24 lg:py-28 bg-[#0A1A2F]">
      <div className="page-container">
        ...
        >
          ...
          <Link
            href="/contact"
            className="concepta-button inline-flex items-center justify-center px-7 py-4 bg-white text-[var(--color-link)] text-sm font-semibold hover:bg-blue-50 hover:text-[var(--color-link-hover)] transition-colors"
          >
            Talk to an Expert
