...
const partners: Partner[] = [
  ...
  {
    name: "AWS",
    src: "/assets/partners/aws-logo-logo-png-transparent.png",
    displayHeight: 40,
    padX: 8,
    fullColor: false,
  },
  {
    name: "Google Cloud",
    src: "/assets/partners/240-2401729_our-strategic-approach-provides-our-customers-maximum-google-cloud-logo-vector.jpg",
    displayHeight: 40,
    padX: 8,
    fullColor: false,
  },
  ...
  {
    name: "NetApp",
    src: "/assets/partners/441-4419073_public-private-cloud-hosting-solutions-company-art-netapp-logo.jpg",
    displayHeight: 40,
    padX: 8,
    fullColor: false,
  },
  {
    name: "AvePoint",
    src: "/assets/partners/avepoint-logo-png.png",
    displayHeight: 40,
    padX: 8,
    fullColor: false,
  },
